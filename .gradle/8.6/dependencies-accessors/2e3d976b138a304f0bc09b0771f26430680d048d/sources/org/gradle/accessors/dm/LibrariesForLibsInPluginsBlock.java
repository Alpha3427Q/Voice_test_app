...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final PicovoiceLibraryAccessors laccForPicovoiceLibraryAccessors = new PicovoiceLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>picovoice</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public PicovoiceLibraryAccessors getPicovoice() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForPicovoiceLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class PicovoiceLibraryAccessors extends SubDependencyFactory {
        private final PicovoicePorcupineLibraryAccessors laccForPicovoicePorcupineLibraryAccessors = new PicovoicePorcupineLibraryAccessors(owner);

        public PicovoiceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>picovoice.porcupine</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PicovoicePorcupineLibraryAccessors getPorcupine() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPicovoicePorcupineLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class PicovoicePorcupineLibraryAccessors extends SubDependencyFactory {

        public PicovoicePorcupineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>ai.picovoice:porcupine-android</b> coordinates and
         * with version reference <b>picovoice.porcupine</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("picovoice.porcupine.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final PicovoiceVersionAccessors vaccForPicovoiceVersionAccessors = new PicovoiceVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.picovoice</b>
         */
        public PicovoiceVersionAccessors getPicovoice() {
            return vaccForPicovoiceVersionAccessors;
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.datastore</b> with value <b>1.1.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.lifecycle</b> with value <b>2.9.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxActivityVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.activity.compose</b> with value <b>1.12.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.compose.bom</b> with value <b>2026.01.01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxCoreVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.core.ktx</b> with value <b>1.17.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PicovoiceVersionAccessors extends VersionFactory  {

        public PicovoiceVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>picovoice.porcupine</b> with value <b>4.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPorcupine() { return getVersion("picovoice.porcupine"); }
